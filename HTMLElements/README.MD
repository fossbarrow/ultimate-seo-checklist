...
Meta Refresh Redirect is important because it gives ranking authority to the redirect target URL as much as possible when the right redirect parameters are set.
